...
# * To Download Plugins, Hooks , Styles , Updates ... Visiting Our Website
	...
	include('includes/ctitles.class.php');
	...
	$control = new TitlesControl();
	
	if(UserGroup(GetUserid,"admin_title") == 1){
	...
	if($eaf->_REQUEST['action'] == "add_title"){
	...
	if($eaf->_REQUEST['action'] == "delete_title"){

		$control->DeleteSmile();

	}

	if($eaf->_REQUEST['action'] == "edit_title"){
