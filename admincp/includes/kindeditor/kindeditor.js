...
KE.lang = {
	source : 'المصدر / التصميم',
	undo : '(Ctrl+Z)تراجع',
	redo : '(Ctrl+Y)العودة عن التراجع',
	cut : '(Ctrl+X)قص',
	copy : '(Ctrl+C)نسخ',
	paste : '(Ctrl+V)لصق',
	plainpaste : 'لصق كنص عادي',
	wordpaste : 'لصق من مايكروسوفت وورد',
	selectall : 'تحديد الكل',
	justifyleft : 'محاذاة النص لليسار',
	justifycenter : 'توسيط النص',
	justifyright : 'محاذاة النص لليمين',
	justifyfull : 'توزيع',
	insertorderedlist : 'تعداد رقمي',
	insertunorderedlist : 'تعداد نقطي',
	...
	image : 'صورة',
	flash : 'إدراج فلاش',
	media : 'إدراج الوسائط المتعددة',
	table : 'إدراج جدول',
	hr : 'إدراج خط النظام',
	emoticons : 'إدراج إبتسامات',
	link : 'إدراج ارتباط تشعبي',
	unlink : 'ازالة ارتباط تشعبي',
	...
	editLink : 'تحرير ارتباط تشعبي',
	deleteLink : 'إزالة ارتباط تشعبي',
	noColor : 'شفاف',
