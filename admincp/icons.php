...
# * To Download Plugins, Hooks , Styles , Updates ... Visiting Our Website	session_start();
	...
	include('includes/cicons.class.php');
	...
	$control = new Icons_Control_System();
	...
	if($eaf->_REQUEST['action'] == "add_icon"){
	...
	if($eaf->_REQUEST['action'] == "delete_icon"){

		$control->DeleteSmile();
	
	}

	if($eaf->_REQUEST['action'] == "edit_icon"){
